    ...
    case 'check_update':
        ...
        $releases = [
            ...
            [
                'version_name' => '1.0.6',
                'version_code' => 7,
                'update_url'   => 'https://github.com/Caretel/dabaindia-app-releases/releases/download/v1.0.6/dabaindia-attendance-v1.0.6-signed.apk',
            ...
            [
                'version_name' => '1.0.7',
                'version_code' => 8,
                'update_url'   => 'https://github.com/Caretel/dabaindia-app-releases/releases/download/v1.0.7/dabaindia-attendance-v1.0.7-signed.apk',
